...
Telego автоматически определяет локальный WEB-бэкенд из `[general].bind-to`. В большинстве конфигураций параметр `backend` не нужен.
...
# carrier = "https-lanes"
# bind-to = "127.0.0.1:8080"
# backend = "127.0.0.1:443" # Необязательное переопределение локального бэкенда
# trusted-proxy-cidrs = ["127.0.0.1/32"]
